...
submitBtn.addEventListener('click', (event) =>{
  ...
  newParagraph.innerText = `His name is ${firstN} ${lastN} and his message is ${messageInput}.`;
  console.log(firstN, lastN, messageInput);
})
...
// let finalMessage = document.getElementsByClassName("test");

  // finalMessage.appendChild(newParagraph);
  // let finalMessage = document.getElementById('submitResult');
